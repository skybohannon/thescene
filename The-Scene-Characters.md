# The Scene (2004–2006) — Characters and Handles

Almost nobody in *The Scene* is called by their name. They are called by their handles, most of them have several, and the handles change between networks, between episodes, and when someone wants to be someone else. This is the index to both seasons: who each handle belongs to, who plays them where the credits say, and where to find them in the synopses.

It is a companion to [the season 1 synopsis](The-Scene-S01-Episode-Synopses.md) and [the season 2 synopsis](The-Scene-S02-Episode-Synopses.md), and like them it gives the endings away. The fuller character notes are at the back of each synopsis; this page is for finding your way.

The **Episodes** column lists the episode entries in the synopsis that name the character, on screen or in someone else's window. It is a map of the writing rather than a screen-time log: a character discussed in their absence counts, and one referred to only as "her daughter" does not.

## Season 1 — *The Scene* (2004–2006)
...
| Handle | Who | Played by | Episodes | In one line |
| --- | --- | --- | --- | --- |
| **melissbliss04** | Melissa, his girlfriend | Trice Able | 1–4, 7–13, 18, 20 | Takes over his machine in episode 10, looks straight at the channel, and finds it boring. |
| **danaburke55**, then **danaburke123** | Dana Burke | Laura Minarich | 4, 7–9, 11, 12, 18, 20 | A one-time hookup who won't let go. On camera once, in episode 4; text only after that. |
| **Tremor2212** | Todd, his friend | — | 1, 7–12, 14, 20 | Same statistics class. The connective tissue between Brian, Melissa and Dana. |
| **suzyxiao** | Suzy, Melissa's friend | — | 9, 10, 12, 18, 20 | Melissa's confidante, and by episode 18 her messenger. |

### Buyers, middlemen and the Bureau
...
Season 2's credits don't list the cast against its characters, so there is no "Played by" column here.

### Family

| Name | Who | Episodes | In one line |
| --- | --- | --- | --- |
...
## The one thread between the seasons

The sequel shares no characters with the original, except one who never appears in it. The machine season 2 is shot on is logged in to Windows as **David**: the Start menu says so in episode 1, and episode 4's FTP client shows `C:\Documents and Settings\David\Desktop`. Nobody in season 2 is called David. In season 1, pyr0 is, and the name is only ever spoken aloud, in episode 14. The production seems to have kept the encoder's computer, and nobody renamed its user profile.

## Every handle, A–Z

| Handle | Season | Character |
| --- | --- | --- |
...
| cOda | 1 | cOda |
| collangello998 | 1 | teflon |
| copleyr785 | 1 | teflon |
| danaburke55, danaburke123 | 1 | Dana Burke |
| DanikaLi99 | 2 | Danika |
| dro_5544 | 1 | Drosan |
| Drosan | 1 | Drosan (Brian Sandro) |
...
| spinnaker | 1 | teflon |
| suzyxiao | 1 | Suzy |
| t!nman@jabber.org | 2 | Murph |
| t0mb0@jabber.org | 2 | Tomasz |
| talisman | 2 | lukai's old contact, on IRC |
| tann3r@jabber.org | 2 | Stan |
| teflon | 1 | Edward G. Koenig |
| Tremor2212 | 1 | Todd |
| trooper, troopercamy | 1 | Jodi |
